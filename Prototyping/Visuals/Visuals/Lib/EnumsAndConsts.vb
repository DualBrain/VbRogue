Namespace Rogue.Lib
  Public Class EnumsAndConsts
    ...
    Public Const MapLevelGridRowMax As Integer = 3 ' The highest number of level grid sections height and width
    Public Const MapLevelGridColumnMax As Integer = 3 ' The highest number of level grid sections height and width
