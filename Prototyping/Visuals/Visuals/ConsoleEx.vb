...
Friend NotInheritable Class ConsoleEx
...
#Region "WIN32"
  ...
  '<DllImport("kernel32.dll", SetLastError:=True)>
  'Private Shared Function GetConsoleScreenBufferInfoEx(ByVal hConsoleOutput As IntPtr, ByRef csbe As CONSOLE_SCREEN_BUFFER_INFO_EX) As Boolean
  'End Function
  ...
  '<DllImport("kernel32.dll", SetLastError:=True)>
  'Private Shared Function SetConsoleScreenBufferInfoEx(hConsoleOutput As IntPtr, ByRef csbe As CONSOLE_SCREEN_BUFFER_INFO_EX) As Boolean
  'End Function
